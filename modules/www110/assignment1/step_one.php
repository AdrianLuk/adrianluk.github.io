...
<fieldset>
	...
	<div class="form-check p-2 m-3 text-center">
		<label class="form-check-label p-2" for="robot"  style="font-family: 'Press Start 2P', cursive; font-size: 1.8rem">
...
<p id="error" class="lead text-center text-danger">All fields are required</p>
